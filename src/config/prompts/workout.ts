...
- Calorie and fat burn are auto-estimated when body weight is set (update_user_settings with bodyWeightKg).
...
- For workout photos: call log_workout or log_bulk_workouts. Include sets, reps, weightKg, durationMin. Do NOT call get_workout_summary or get_nutrition_summary.`;
